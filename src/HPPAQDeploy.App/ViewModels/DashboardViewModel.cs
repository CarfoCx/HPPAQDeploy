...
public partial class DashboardViewModel : ObservableObject
{
    ...
    private async Task LoadDataAsync()
    {
        try
        {
            ...
            // Only count devices that have actually been analyzed as "up to date"
            ...
            // Compliance = analyzed devices with no pending updates / total analyzed devices
    ...
    private async Task ExportCsvReportAsync()
    {
        ...
        {
            ExportStatus = "No devices to export.";
            return;
        }
        ...
        try
        {
            ...
            Services.SnackbarService.Show("Compliance CSV exported");
    ...
    private async Task ExportHtmlReportAsync()
    {
        ...
        try
        {
            ...
            Services.SnackbarService.Show("Compliance HTML report exported");
